...
SECTION_ORDER = {
    ...
    "scholarship": [
        ...
        "Manuscript language editing", "Pre-submission critique",
...
SCHOLARSHIP_SECTIONS = {
    ...
    "language-editing-guardrailed": "Manuscript language editing",
    "discussion-outline-from-notes": "Manuscript language editing",
    ...
    "response-to-reviewers-organizer": "Manuscript language editing",
    "limitations-section-drafting": "Manuscript language editing",
    "abstract-structuring-from-results": "Manuscript language editing",
    "cover-letter-structure": "Manuscript language editing",

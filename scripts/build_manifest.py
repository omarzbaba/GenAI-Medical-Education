...
SECTION_ORDER = {
    ...
    "scholarship": [
        ...
        "Manuscript improvement", "Pre-submission critique",
...
SCHOLARSHIP_SECTIONS = {
    ...
    "language-editing-guardrailed": "Manuscript improvement",
    "discussion-outline-from-notes": "Manuscript improvement",
    ...
    "response-to-reviewers-organizer": "Manuscript improvement",
    "limitations-section-drafting": "Manuscript improvement",
    "abstract-structuring-from-results": "Manuscript improvement",
    "cover-letter-structure": "Manuscript improvement",
